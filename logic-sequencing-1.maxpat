...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 274.0, 322.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 274.0, 569.0, 29.5, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 274.0, 521.0, 84.0, 22.0 ],
					"text" : "mc.unpack~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 17.0, 639.0, 55.0, 22.0 ],
					"text" : "adc~ 7 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 675.0, 55.0, 22.0 ],
					"text" : "dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 521.0, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 274.0, 480.0, 50.0, 22.0 ],
					"text" : "mc.*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 274.0, 440.0, 300.0, 22.0 ],
					"text" : "mc.gen~ bs.logic-seq1 @chans 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 274.0, 356.0, 62.0, 22.0 ],
					"text" : "phasor~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 274.0, 602.0, 61.0, 59.0 ],
					"range" : [ -0.1, 1.1 ]
				}
