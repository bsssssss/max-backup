...
var myObjects = [];
myObjects.push(new JsClassObject(this, 10, [1.0, 0.0, 0.0, 0.7],5.7, 7.1));
myObjects.push(new JsClassObject(this, 15, [0.0, 1.0, 0.0, 0.7],9.7, 4.1));
myObjects.push(new JsClassObject(this, 8, [0.0, 0.0, 1.0, 0.7],10.7, 15.1));
myObjects.push(new JsClassObject(this, 20, [0.5, 0.5, 0.0, 0.7],3.7, 4.1));
