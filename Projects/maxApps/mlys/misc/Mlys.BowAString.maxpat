...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 256.0, 89.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 336.0, 142.0, 85.0, 19.0 ],
					"text" : "Scale position",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 240.0, 128.0, 177.0, 39.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 344.0, 288.0, 178.0, 39.0 ],
										...
										"slots" : 										{
											"1" : 											{
												...
												"data" : 												{
													...
													"Fma.SignalMapper~::OutMax" : [ -0.039996 ],
													"Fma.SignalMapper~::OutMin" : [ 0.039996 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 344.0, 280.0, 168.0, 39.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 512.0, 120.0, 182.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 120.0, 89.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 142.0, 89.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 48.0, 136.0, 256.0, 104.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 160.0, 256.0, 104.0 ],
					"varname" : "Fma.LFO~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 304.0, 264.0, 65.0, 18.0 ],
									"saved_object_attributes" : 									{
										"name" : "Speed",
										"speed" : 50.0,
										"weight" : 1.0
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 200.0, 312.0, 123.0, 18.0 ],
									"saved_object_attributes" : 									{
										"initial-position-in" : 0.01,
...
, 							{
								"box" : 								{
									...
									"saved_object_attributes" : 									{
										"access-in-initial-position" : [ 0.0, 1.0 ],
										"access-in-type" : [ "trans0", "trans1" ],
										"access-out-initial-position" : [ 1.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 336.0, 300.0, 88.0, 40.0 ],
...
,
					"patching_rect" : [ 48.0, 400.0, 170.0, 33.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial Bold",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 48.0, 272.0, 256.0, 104.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 336.0, 160.0, 256.0, 104.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 608.0, 64.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 640.0, 448.0, 64.0, 33.0 ],
					"text" : "< Turn Audio on!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 688.0, 376.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 18.0, 155.0, 33.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.0, 685.0, 64.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 40.0, 624.0, 65.0, 33.0 ],
					"text" : "Mlys",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 48.0, 609.0, 43.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 48.0, 66.0, 612.0, 43.0 ],
