...
,
		"classnamespace" : "box",
		"rect" : [ -1157.0, 169.0, 1155.0, 763.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 919.0, 696.0, 66.0, 23.0 ],
					"text" : "mc.dup~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 919.0, 721.0, 118.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1808.51062536239624, 1457.446798086166382, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 919.0, 671.0, 40.0, 23.0 ],
					"text" : "tanh~"
				}
