...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 200.5, 111.0, 61.0, 20.0 ],
					"text" : "route tidal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 216.0, 52.0, 20.0 ],
					"text" : "1 $1 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 240.0, 35.0, 18.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 50.0, 263.0, 33.0, 20.0 ],
					"text" : ">~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 239.0, 34.0, 20.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 50.0, 192.0, 71.0, 20.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 102.0, 78.0, 117.5, 20.0 ],
					"text" : "route duration"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 36.0, 54.0, 85.0, 20.0 ],
					"text" : "route previous"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 225.0, 339.0, 42.0, 20.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 249.0, 192.0, 99.0, 20.0 ],
					"text" : "dirt-param #1 1"
				}
...
, 			{
				"box" : 				{
					"comment" : "state signal",
					"id" : "obj-13",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 377.0, 363.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "", "" ],
					"patching_rect" : [ 200.5, 146.0, 67.5, 20.0 ],
					"text" : "t b l l"
				}
...
, 			{
				"box" : 				{
					"comment" : "mute message",
					"id" : "obj-5",
					"index" : 3,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 529.0, 363.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 170.0, 215.0, 20.0 ],
					"text" : "tidal-adsr-stages #1 #2 #3 #4 #5"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 225.0, 315.0, 323.0, 20.0 ],
					"text" : "live.adsr~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 363.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 111.5, 105.0, 430.5, 105.0 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 210.0, 177.0, 59.5, 177.0 ],
					"source" : [ "obj-6", 0 ]
				}
