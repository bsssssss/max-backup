...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 106.5, 79.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.0, 12.5, 75.0, 20.0 ],
					"text" : "drop sample",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 227.0, 24.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 42.0, 43.0, 20.0 ],
					"text" : "db",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 81.0, 255.0, 39.0, 22.0 ],
					"text" : "dbtoa"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 81.0, 226.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 41.0, 50.0, 22.0 ],
					"textcolor" : [ 0.819607843137255, 0.819607843137255, 0.819607843137255, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 85.0, 106.0, 41.0, 22.0 ],
					"text" : "sig~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 50.0, 106.0, 22.0, 22.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.0, 135.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 158.0, 100.0, 95.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 6.0, 95.0, 33.0 ],
					"rounded" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 157.0, 159.0, 109.0, 22.0 ],
					"text" : "buffer~ #0-smp1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 159.0, 116.0, 22.0 ],
					"text" : "groove~ #0-smp1"
				}
