...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 665.0, 541.0, 35.0, 23.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 674.0, 448.0, 43.0, 23.0 ],
					"text" : "ctrllist"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 605.0, 235.0, 33.0, 23.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 619.0, 339.0, 502.0, 23.0 ],
					"text" : "read \"/Users/maxim/OneDrive/Documents/Max 8/Projects/modalys/code/obj-reverb1.lua\""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 605.0, 200.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 367.0, 52.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 423.0, 84.0, 23.0 ],
					"saved_object_attributes" : 					{
						"name" : "Collector"
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.0, 448.0, 67.0, 23.0 ],
					"saved_object_attributes" : 					{
						"angle-mode" : "degree",
						"multi" : 0,
						"precision" : "double"
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 605.0, 501.0, 79.0, 23.0 ],
					"saved_object_attributes" : 					{
						"precision" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 605.0, 611.0, 136.0, 47.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 644.5, 595.0, 731.5, 595.0 ],
					"source" : [ "obj-4", 1 ]
				}
