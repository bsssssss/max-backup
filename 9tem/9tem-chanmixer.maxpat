...
,
		"classnamespace" : "box",
		"rect" : [ 808.0, 254.0, 328.0, 311.0 ],
		"bglocked" : 0,
		"openinpresentation" : 1,
		"default_fontsize" : 17.0,
		"default_fontface" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 771.0, 499.0, 31.0, 23.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 771.0, 449.0, 31.0, 23.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 771.0, 542.0, 86.0, 23.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 771.0, 573.0, 118.0, 23.0 ],
					"text" : "text $1, texton $1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"activebgoncolor" : [ 0.529411764705882, 0.592156862745098, 0.647058823529412, 0.9 ],
					...
					"lcdcolor" : [ 0.486274509803922, 0.486274509803922, 0.486274509803922, 1.0 ],
					"maxclass" : "live.text",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 771.0, 605.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 1.0, 43.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 574.0, 566.0, 71.0, 23.0 ],
					"text" : "mc.pack~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 508.0, 68.0, 23.0 ],
					"text" : "loadmess 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 772.0, 338.0, 71.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.22222313284874, 107.0, 68.0, 23.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 3070.0, 2081.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 119.22222313284874, 155.0, 36.0, 124.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 30.0, 1.0, 13.0, 163.0 ],
					"setminmax" : [ -70.0, 12.0 ],
					"setstyle" : 1,
					"slidercolor" : [ 0.380392156862745, 0.380392156862745, 0.380392156862745, 1.0 ],
					"thickness" : 4,
					"varname" : "track-dBu_slider"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 505.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 462.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.0, 184.0, 46.0, 37.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.22222313284874, 283.0, 53.0, 23.0 ],
					"text" : "dbtoa"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 220.0, 243.0, 51.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 70.0, 46.0, 23.0 ],
					"textcolor" : [ 0.486274509803922, 0.486274509803922, 0.486274509803922, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.22222313284874, 311.0, 74.0, 23.0 ],
					"text" : "append 20."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 384.0, 389.0, 37.0, 23.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 312.0, 389.0, 37.0, 23.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 119.22222313284874, 338.0, 46.0, 23.0 ],
					"text" : "curve~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 772.0, 365.0, 87.0, 37.0 ],
					"text" : "text M, texton M, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 674.0, 247.0, 179.0, 23.0 ],
					"restore" : 					{
						"track-dBu" : [ 0.0 ],
						"track-dBu_slider" : [ 0.0 ],
						"track-mute" : [ 0.0 ],
						"track-routing" : [ 4.0 ],
						"track-solo" : [ 0.0 ]
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 257.0, 474.0, 51.0, 23.0 ],
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"oncolor" : [ 0.243137254901961, 0.270588235294118, 0.298039215686275, 1.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 574.0, 593.0, 58.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, -2.0, 20.0, 170.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 500.0, 560.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 400.0, 210.0, 24.0, 24.0 ]
								}
...
,
					"patching_rect" : [ 312.0, 474.0, 478.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 619.5, 424.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 127.0, 20.992797777056694, 19.163623154163361 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 772.0, 424.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 74.0, 127.0, 20.992797777056694, 19.163623154163361 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 50.0, 95.0, 29.5, 23.0 ],
									"text" : "+ 1"
								}
...
,
					"patching_rect" : [ 120.0, 566.0, 404.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Ableton Sans Medium",
...
, 			{
				"box" : 				{
					...
					"appearance" : 1,
					"fontsize" : 12.0,
					"hltcolor" : [ 0.129411764705882, 0.129411764705882, 0.129411764705882, 0.0 ],
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 120.0, 535.0, 44.444446265697479, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 149.0, 43.992797777056694, 18.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"oncolor" : [ 0.243137254901961, 0.270588235294118, 0.298039215686275, 1.0 ],
					"outlettype" : [ "float" ],
					"patching_rect" : [ 257.0, 502.0, 58.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 31.0, 13.0, 137.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 312.0, 240.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 384.0, 240.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 163.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 377.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 248.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 603.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 321.5, 435.0, 266.5, 435.0 ],
					"order" : 1,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-53", 0 ],
					"midpoints" : [ 393.5, 435.0, 266.5, 435.0 ],
					"order" : 1,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-36", 0 ],
					"midpoints" : [ 780.5, 525.0, 813.0, 525.0, 813.0, 420.0, 781.5, 420.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 128.72222313284874, 375.0, 339.5, 375.0 ],
					"order" : 1,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 128.72222313284874, 375.0, 411.5, 375.0 ],
					"order" : 0,
					"source" : [ "obj-5", 0 ]
				}
