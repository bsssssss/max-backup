...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.5, 106.0, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 217.0, 221.0, 29.5, 22.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 195.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "reset" ],
					"patching_rect" : [ 262.0, 338.0, 42.0, 22.0 ],
					"text" : "t reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "pause" ],
					"patching_rect" : [ 111.0, 338.0, 48.0, 22.0 ],
					"text" : "t pause"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "play" ],
					"patching_rect" : [ 98.0, 312.0, 37.0, 22.0 ],
					"text" : "t play"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 98.0, 286.0, 44.0, 22.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 98.0, 55.0, 23.0, 22.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 262.0, 312.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
,
					"patching_rect" : [ 273.5, 195.0, 28.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"lcdcolor" : [ 0.541176470588235, 0.607843137254902, 0.658823529411765, 1.0 ],
					"maxclass" : "live.text",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					...
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 0.0, 37.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 98.0, 140.0, 39.866668493747966, 20.0 ],
					"pictures" : [ "no.play.svg", "no.play.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 37.0, 16.0 ],
					"remapsvgcolors" : 1,
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 98.0, 385.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 283.0, 222.915344953536987, 311.691649377346039, 222.915344953536987, 311.691649377346039, 156.619048535823822, 278.5, 156.619048535823822 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 226.5, 250.0, 320.0, 250.0, 320.0, 103.0, 124.0, 103.0 ],
					"source" : [ "obj-8", 0 ]
				}
